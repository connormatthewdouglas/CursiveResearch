...
Source: https://www.nature.com/articles/s41586-023-06924-6 | RSI-002 | Extraction only
...
| 3 | Improved heuristics for bin-packing-class problems | OR benchmarks | Medium — **[needs full-text numbers]** |
...
| Search efficiency | Fewer programs to strong solutions vs traditional search | **[needs full-text]** |

## What Not To Overclaim

- Nature full text not in corpus; numeric tables paraphrase-only.
