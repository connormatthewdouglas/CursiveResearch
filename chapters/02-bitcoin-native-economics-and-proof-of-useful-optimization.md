...
This is a major departure from the imported DePIN-tokenomics research. Chapter 21 remains useful for comparison, but CursiveOS's current design should be evaluated as a Bitcoin-native revenue distribution organism, not as another emissions-based DePIN network.
...
Chapter 21 remains useful for DePIN comparison, but it no longer describes CursiveOS's preferred design.
