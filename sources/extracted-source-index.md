...
| SRC-09-010 | Hermes OVMS Tool-Envelope Smoke Test | CursiveOS / Codex | `experiments/results/2026-05-26-hermes-ovms-tool-envelope-smoke-test.md` | internal benchmark | 2026-05-26 | 2026-05-26 | `09-local-agent-arc-b70.md` correction and benchmark plan | Current Hermes 64k context minimum, deployed 65,536 context, viable OVMS structured tool calls, and diagnostic latency sensitivity to tool-schema footprint | A | partially verified | Local diagnostic artifact; contains single-run and cache-uncontrolled observations. Not decision-grade until repeated under the benchmark plan. |
...
- Chapter 05 is architecture-relevant, but performance numbers, maturity claims, license claims, and engineering cost estimates should remain provisional until each repo/paper is inspected and CursiveOS reproduces at least one end-to-end tuning loop.
