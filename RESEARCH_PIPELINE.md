...
| Seed organism parent-vs-candidate screen | Chapter 01 / main repo | Run parent-vs-candidate screens via the one-paste seed session (current: v0.9 parent vs v0.11-zram-swappiness candidate, cycle 3). | In progress in main repo; v0.11 first screen positive (+0.0954 fitness) but single-screen confidence remains 0.50. | Confirm with reversed order + second machine, then accept/promote v0.11 if positive. |
