...
| Seed organism parent-vs-candidate screen | Chapter 01 / main repo | Run parent-vs-candidate screens via the one-paste seed session. | Cycle 3 closed: v0.11 accepted (confidence 0.875); parent promoted to v0.12. | Next screens use v0.12 parent; optional swappiness tune vs v0.12b. |
...
| Concurrent inference throughput benchmark | Chapter 22 / action plan parking lot | Measure requests/sec under parallel load, where scheduler tweaks should actually show. | Shipped (`benchmark-inference-concurrency-v0.1.sh`); observe-only in harness. | Screen scheduler-axis candidate vs v0.12; re-test H3 signal gate. |
